...
<body>
<h1>Method type:<s:property value="postBack"/></h1>
	<s:form action="/editstudentpost" method="POST">
		...
		<s:radio name="studentBeam.gender" label="Gender"
			list="#{'Male':'Male','Female':'Female','Others':'Others'}"
			value="%{=studentBeam.gender}"></s:radio>
		<s:hidden name="postBack" value="POST"></s:hidden>
