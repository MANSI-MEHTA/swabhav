...
<body>
	...
	<table class="table table-responsive">
		...
		<s:iterator value="listOfStudents" var="list">
			<tr>
				...
				<td><s:property value="clg_id" /></td>
				<td><s:property value="cgpi" /></td>
				<td><s:property value="gender" /></td>
				<td><a
					href="/student-college-app/editstudent?id=<s:property value="rollno"/>"
	...
	<a href="/student-college-app/addstudent" class="btn btn-info">Add Student</a>
	<s:if test="sessionMap.username==null">
		<a href="/student-college-app/login" class="btn btn-primary">Login</a>
	</s:if>
	<s:else>
		<a href="/student-college-app/logout" class="btn btn-primary">logout</a>
	</s:else>
</body>
</htmt>