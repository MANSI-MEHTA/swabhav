...
public class StudentService {
	...
	public static StudentService getInstanceOf() {
		if (object == null) {
			...
			Studentlist.add(new Student(101, "varshil", "mehta", 8.5, "male"));
			Studentlist.add(new Student(102, "manoj", "m", 9, "male"));
			Studentlist.add(new Student(103, "shubham", "vora", 9.5, "male"));
